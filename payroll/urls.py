...
urlpatterns = [
    ...
    path("penalties/<int:pk>/waive/undo/", views.penalty_unwaive, name="penalty_unwaive"),
    ...
    path("payslips/<int:pk>/corrections/add/", views.payslip_correction_add, name="payslip_correction_add"),
